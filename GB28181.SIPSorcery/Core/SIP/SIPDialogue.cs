...
namespace GB28181
{
    ...
    public class SIPDialogue
    {
            ...
            Owner
        {
            get;
            set;
        } // In cases where ownership needs to be set on the dialogue this value can be used. Does not have any effect on the operation of the dialogue and is for info only.
        ...
        public SIPCallDirection
            Direction { get; set; } // Indicates whether the dialogue was created by a ingress or egress call.
            ...
            string adminMemberId)
        {
            ...
            RemoteTarget = new SIPURI(uacInviteTransaction.TransactionRequest.URI.Scheme,
                SIPEndPoint.ParseSIPEndPoint(uacInviteTransaction.RemoteEndPoint.ToString()));
