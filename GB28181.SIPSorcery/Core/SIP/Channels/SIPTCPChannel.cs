...
namespace GB28181
{
    public class SIPTCPChannel : SIPChannel
    {
        ...
        private List<string>
            m_connectingSockets =
                new List<string>(); // List of sockets that are in the process of being connected to. Need to avoid SIP re-transmits initiating multiple connect attempts.

        private Dictionary<string, int>
            m_connectionFailureStrikes =
                new Dictionary<string, int>(); // Tracks the number of connection attempts made to a remote socket, three strikes and it's out.
        ...
        private void Initialise()
        {
            try
            {
                ...
                m_tcpServerListener.Server.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReuseAddress,
                    true);
        ...
        {
            throw new ApplicationException(
                "This Send method is not available in the SIP TCP channel, please use an alternative overload.");
        }
