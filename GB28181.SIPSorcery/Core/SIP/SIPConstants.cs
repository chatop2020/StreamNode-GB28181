...
namespace GB28181
{
    public class SIPConstants
    {
        ...
        public const int
            SIP_MAXIMUM_UDP_SEND_LENGTH =
                1300; // Any SIP messages over this size should be prevented from using a UDP transport.

        public const string SIP_USERAGENT_STRING = "StreamNodeSipGate/1.0";
        public const string SIP_SERVER_STRING = "StreamNodeSipGate/1.0";
    ...
    {
        public const int
            T1 = 500; // Value of the SIP defined timer T1 in milliseconds and is the time for the first retransmit.

        public const int
            T2 = 4000; // Value of the SIP defined timer T2 in milliseconds and is the maximum time between retransmits.

        public const int
            T6 = 64 * T1; // Value of the SIP defined timer T6 in milliseconds and is the period after which a transaction has timed out.

        public const int
            MAX_RING_TIME =
                180000; // The number of milliseconds a transaction can stay in the proceeding state (i.e. an INVITE will ring for) before the call is given up and timed out.     
    }
