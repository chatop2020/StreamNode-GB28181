...
namespace GB28181
{
    ...
    public class SIPMessage
    {
       ...
       // private static ILog logger = AssemblyState.logger;
        ...
        public static SIPMessage ParseSIPMessage(string message, SIPEndPoint localSIPEndPoint,
            SIPEndPoint remoteSIPEndPoint)
        {
            try
            {
                ...
                if (endFistLinePosn != -1)
                {
                    ...
                    if (endHeaderPosn == -1)
                    {
                        ...
                        sipMessage.SIPHeaders =
                            SIPHeader.SplitHeaders(headerString); //Regex.Split(headerString, m_CRLF);
                    }
                    else
                    {
                        string headerString =
