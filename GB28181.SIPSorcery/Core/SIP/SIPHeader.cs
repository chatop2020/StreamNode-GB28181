...
namespace GB28181
{
    ...
    public class SIPViaHeader
    {
        ...
        public SIPViaHeader(string contactEndPoint, string branch) :
            this(IPSocket.GetIPEndPoint(contactEndPoint).Address.ToString(),
                IPSocket.GetIPEndPoint(contactEndPoint).Port, branch, SIPProtocolsEnum.udp)
        {
        }
 ...
 SIPAuthenticationHeader.ParseSIPAuthenticationHeader(SIPAuthorisationHeadersEnum.ProxyAuthorization, "Digest realm=\"o-fone.com\",nonce=\"mv1keFTRX4yYVsHb/E+rviOflIurIw\",algorithm=MD5,qop=\"auth\",username=\"joe.bloggs\", response=\"1234\",uri=\"sip:o-fone.com\"");
    ...
    public class SIPViaSet
    {
		...
		public class SIPViaSetUnitTest
		{
			...
			public void AdjustReceivedViaHeaderTest()
			{
				...
				string xtenViaHeader =
 "SIP/2.0/UDP 192.168.1.2:5065;rport;branch=z9hG4bKFBB7EAC06934405182D13950BD51F001";
 ...
 "SIP/2.0/UDP 192.168.1.2:5065;rport;branch=z9hG4bKFBB7EAC06934405182D13950BD51F001";
    ...
    public class SIPHeader
    {
        ...
        public string
            ReferSub; // RFC 4488 If set to false indicates the implict REFER subscription should not be created.
        ...
        public string
            SwitchboardOriginalCallID; // The original Call-ID header on the call that was forwarded to the switchboard.
        ...
        public string
            SwitchboardOwner; // If a switchboard operator "grabs" a call then they will take exclusive ownership of it. This field records the owner.

        public string
            SwitchboardTerminate; // Can be set on a BYE request to indicate whether the switchboard is requesting both, current or opposite dialogues to be hungup.
            ...
            string callId)
        {
            ...
            From = from ?? throw new ApplicationException(
                "The From header cannot be empty when creating a new SIP header.");
        ...
        public new string ToString()
        {
            try
            {
                ...
                headersBuilder.Append((ProxySendFrom != null)
                    ...
                    : null);
                headersBuilder.Append((SwitchboardOriginalCallID != null)
                    ? SIPHeaders.SIP_HEADER_SWITCHBOARD_ORIGINAL_CALLID + ": " + SwitchboardOriginalCallID + m_CRLF
                    : null);
                ...
                headersBuilder.Append((SwitchboardLineName != null)
                    ? SIPHeaders.SIP_HEADER_SWITCHBOARD_LINE_NAME + ": " + SwitchboardLineName + m_CRLF
                    : null);
                ...
                headersBuilder.Append((SwitchboardOwner != null)
                    ? SIPHeaders.SIP_HEADER_SWITCHBOARD_OWNER + ": " + SwitchboardOwner + m_CRLF
                    : null);
                headersBuilder.Append((SwitchboardTerminate != null)
                    ? SIPHeaders.SIP_HEADER_SWITCHBOARD_TERMINATE + ": " + SwitchboardTerminate + m_CRLF
                    : null);
