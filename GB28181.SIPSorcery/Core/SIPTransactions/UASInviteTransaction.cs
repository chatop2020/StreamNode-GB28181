...
namespace GB28181
{
    ...
    public class UASInviteTransaction : SIPTransaction
    {
        ...
        private IPAddress
            m_contactIPAddress; // If set this IP address should be used in the Contact header of the Ok response so that ACK requests can be delivered correctly.
        ...
        private void UASInviteTransaction_TransactionResponseReceived(SIPEndPoint localSIPEndPoint,
        ...
        public void CancelCall()
        {
            try
            {
                    ...
                    TransactionState == SIPTransactionStatesEnum.Proceeding)
                {
                    ...
                    SIPResponse cancelResponse = SIPTransport.GetResponse(TransactionRequest,
        ...
        public SIPResponse GetOkResponse(SIPRequest sipRequest, SIPEndPoint localSIPEndPoint, string contentType,
            string messageBody)
        {
            try
            {
                SIPResponse okResponse =
                    new SIPResponse(SIPResponseStatusCodesEnum.Ok, null, sipRequest.LocalSIPEndPoint);

                SIPHeader requestHeader = sipRequest.Header;
                okResponse.Header =
                    new SIPHeader(new SIPContactHeader(null, new SIPURI(sipRequest.URI.Scheme, localSIPEndPoint)),
