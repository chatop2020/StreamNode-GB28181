...
namespace GB28181
{
    public class SIPCancelTransaction : SIPTransaction
    {
        ...
        internal SIPCancelTransaction(SIPTransport sipTransport, SIPRequest sipRequest, SIPEndPoint dstEndPoint,
            SIPEndPoint localSIPEndPoint, UASInviteTransaction originalTransaction)
        ...
        private void SIPCancelTransaction_TransactionFinalResponseReceived(SIPEndPoint localSIPEndPoint,
            SIPEndPoint remoteEndPoint, SIPTransaction sipTransaction, SIPResponse sipResponse)
        {
            ...
            else
            {
                ...
                {
                    CancelTransactionFinalResponseReceived(localSIPEndPoint, remoteEndPoint, sipTransaction,
                        sipResponse);
                }
            }
        }

        private void SIPCancelTransaction_TransactionRequestReceived(SIPEndPoint localSIPEndPoint,
            SIPEndPoint remoteEndPoint, SIPTransaction sipTransaction, SIPRequest sipRequest)
        {
            try
            {
                ...
                {
                    cancelResponse = GetCancelResponse(sipRequest,
        ...
        private SIPResponse GetCancelResponse(SIPRequest sipRequest, SIPResponseStatusCodesEnum sipResponseCode)
        {
            try
            {
                ...
                cancelResponse.Header = new SIPHeader(requestHeader.From, requestHeader.To, requestHeader.CSeq,
