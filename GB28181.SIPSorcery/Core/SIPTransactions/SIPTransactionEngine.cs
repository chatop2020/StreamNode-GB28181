...
namespace GB28181
{
    public class SIPTransactionEngine : ISIPTransactionEngine
    {
        ...
        public SIPTransaction GetTransaction(SIPRequest sipRequest)
        {
            ...
            var contactAddress = (sipRequest.Header.Contact != null && sipRequest.Header.Contact.Count > 0)
                ? sipRequest.Header.Contact[0].ToString()
                : "no contact";
                    ...
                    if (sipRequest.Method == SIPMethodsEnum.ACK)
                    {
                        ...
                        foreach (SIPTransaction transaction in m_transactions.Values)
                        {
                                ...
                                transaction.TransactionFinalResponse != null)
                            {
                                ...
                                {
                                    string requestEndPoint = (sipRequest.RemoteSIPEndPoint != null)
                                        ? sipRequest.RemoteSIPEndPoint.ToString()
                                        : " ? ";
        ...
        public class SIPTransactionEngineUnitTest
        {
            ...
            public void Init()
            {
                ...
                GB28181.Logger4Net.Appender.ConsoleAppender appender =
 new GB28181.Logger4Net.Appender.ConsoleAppender();
 ...
 new UACInviteTransaction(new SIPTransport(MockSIPDNSManager.Resolve, null), inviteRequest, dummySIPEndPoint, dummySIPEndPoint, null);
 ...
 SIPRequest.ParseSIPRequest("INVITE sip:dummy@udp:127.0.0.1:12014 SIP/2.0" + m_CRLF +
 ...
 new UACInviteTransaction(clientTransport, inviteRequest, serverEndPoint, clientEndPoint, null);
            ...
            public void AckRecognitionIIUnitTest()
            {
                ...
                SIPEndPoint dummySIPEndPoint = new SIPEndPoint(new IPEndPoint(IPAddress.Loopback, 1234));
                UASInviteTransaction serverTransaction =
 new UASInviteTransaction(new SIPTransport(MockSIPDNSManager.Resolve, null), inviteRequest, dummySIPEndPoint, dummySIPEndPoint, null);
 ...
 new SIPViaHeader("127.0.0.1", 1234, CallProperties.CreateBranchId(), SIPProtocolsEnum.udp);
        ...
        #region Logging
            ...
            void SetTransactionTraceEvents(SIPTransaction transaction)
            {
                ...
                transaction.TransactionStateChanged +=
 new SIPTransactionStateChangeDelegate(transaction_TransactionStateChanged);
                transaction.TransactionTraceMessage +=
 new SIPTransactionTraceMessageDelegate(transaction_TransactionTraceMessage);
            }
