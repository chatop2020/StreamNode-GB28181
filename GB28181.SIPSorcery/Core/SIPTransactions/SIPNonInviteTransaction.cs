...
namespace GB28181
{
    public class SIPNonInviteTransaction : SIPTransaction
    {
        ...
        public SIPNonInviteTransaction(SIPTransport sipTransport, SIPRequest sipRequest, SIPEndPoint dstEndPoint,
        ...
        private void SIPNonInviteTransaction_TransactionRequestReceived(SIPEndPoint localSIPEndPoint,
        ...
        private void SIPNonInviteTransaction_TransactionInformationResponseReceived(SIPEndPoint localSIPEndPoint,
        ...
        private void SIPNonInviteTransaction_TransactionFinalResponseReceived(SIPEndPoint localSIPEndPoint,
            SIPEndPoint remoteEndPoint, SIPTransaction sipTransaction, SIPResponse sipResponse)
        {
