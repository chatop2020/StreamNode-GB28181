...
namespace GB28181.App
{
    ...
    {
        public string
            SwitchboardOriginalCallID; // If set holds a call identifier and is typically the SIP Call-ID of an associated INVITE.
        ...
        public string
            SwitchboardOwner; // If set indicates a specific SIP account is taking ownership of any call that gets established.
    ...
    public class SIPCallDescriptor
    {
       ...
       // private static ILog logger = AppState.logger;
        ...
        public int
            DelaySeconds; // An amount in seconds to delay the intiation of this call when used as part of a dial string.
        ...
        public void ParseCallOptions(string options)
        {
            if (!options.IsNullOrBlank())
            {
                ...
                Match switchboardDescriptionMatch =
                    Regex.Match(options, SWITCHBOARD_LINE_NAME_KEY + @"=(?<lineName>.+?)(,|$)");
