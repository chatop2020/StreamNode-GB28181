...
namespace GB28181.App
{
    ...
    public class SIPB2BUserAgent : ISIPServerUserAgent, ISIPClientUserAgent
    {
        ...
        {
            get { return SIPCallDirection.In; }
        }
            ...
            SIPDialogueTransferModesEnum transferMode)
        {
            try
            {
                ...
                SIPResponse uasOkResponse = SIPTransport.GetResponse(m_uasTransaction.TransactionRequest,
                ...
                SIPResponse uacOkResponse = SIPTransport.GetResponse(m_uacTransaction.TransactionRequest,
                    SIPResponseStatusCodesEnum.Ok, null);
        ...
        public void SetOwner(string owner, string adminMemberId)
        {
            if (m_uasTransaction.CDR != null)
            {
                ...
                m_uasTransaction.CDR.DialPlanContextID = (m_uacCallDescriptor != null)
                    ? m_uacCallDescriptor.DialPlanContextID
                    : Guid.Empty;
