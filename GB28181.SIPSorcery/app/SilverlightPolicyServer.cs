...
namespace GB28181.App
{
    ...
    class PolicyConnection
    {
        ...
        private static string
            s_policyRequestString = "<policy-file-request/>"; // the request that we're expecting from the client 
        ...
        public PolicyConnection(Socket client, byte[] policy)
        {
            ...
            try
            {
                ...
                m_connection.BeginReceive(m_buffer, 0, s_policyRequestString.Length, SocketFlags.None,
        ...
        private void OnReceive(IAsyncResult res)
        {
            try
            {
                ...
                {
                    m_connection.BeginReceive(m_buffer, m_received, s_policyRequestString.Length - m_received,
