...
namespace GB28181.App
{
    ...
    public class SIPDialogueAsset : ISIPAsset
    {
        ...
        [IgnoreDataMember] public SIPDialogue SIPDialogue;
        ...
        public string LocalUserField
        {
            ...
            set
            {
                SIPDialogue.LocalUserField = (!value.IsNullOrBlank()) ? SIPUserField.ParseSIPUserField(value) : null;
            }
        }
        ...
        public string RemoteUserField
        {
            ...
            set
            {
                SIPDialogue.RemoteUserField = (!value.IsNullOrBlank()) ? SIPUserField.ParseSIPUserField(value) : null;
            }
        }
        ...
        public DateTimeOffset? HangupAt
        {
            ...
            set
            {
            } // The hangup time is stored in the database for info. It is calculated from inserted and calldurationlimit and does not need a setter.
        }
        ...
        public string TransferMode
        {
            ...
            set
            {
                ...
                {
                    SIPDialogue.TransferMode =
                        (SIPDialogueTransferModesEnum) Enum.Parse(typeof(SIPDialogueTransferModesEnum), value, true);
                }
            }
        }
