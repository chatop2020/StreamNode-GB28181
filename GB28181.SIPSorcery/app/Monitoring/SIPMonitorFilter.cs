...
namespace GB28181.App
{
    public class SIPMonitorFilter
    {
        ...
        public bool ShowEvent(SIPMonitorEventTypesEnum eventType, SIPEndPoint serverEndPoint)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (EventFilterDescr == WILDCARD && eventType != SIPMonitorEventTypesEnum.FullSIPTrace &&
                        eventType != SIPMonitorEventTypesEnum.UserSpecificSIPTrace)
                    {
                        return true;
                    }
                    else
        ...
        {
            string eventStr = (EventTypeId == 0)
                ? EventFilterDescr
                : SIPMonitorEventTypes.GetProxyEventTypeForId(EventTypeId).ToString();
            string serverStr = (ServerTypeId == 0)
                ? WILDCARD
                : SIPMonitorServerTypes.GetProxyServerTypeForId(ServerTypeId).ToString();

            string filerDescription =
                "basetype=" + BaseType + ", ipaddress=" + IPAddress + ", user=" + Username + ", event=" + eventStr +
                ", request=" + SIPRequestFilter + ", serveripaddress=" + ServerIPAddress + ", server=" + serverStr +
                ", regex=" + RegexFilter + ".";
        ...
        public bool ShowSIPMonitorEvent(SIPMonitorEvent proxyEvent)
        {
                ...
                if (BaseType == MACHINE_BASE_TYPE)
                {
                    ...
                    else
                    {
                        ...
                        if ((machineEvent.MachineEventType == SIPMonitorMachineEventTypesEnum.SIPDialogueCreated ||
                             ...
                             machineEvent.MachineEventType == SIPMonitorMachineEventTypesEnum.SIPDialogueTransfer) &&
                            SIPEventDialogURI != null)
                        {
                            if (SIPEventDialogURI.User == WILDCARD)
                            {
                                return ShowUsername(proxyEvent.Username) &&
                                       ShowMachineEvent(machineEvent.MachineEventType);
                            }
                            else
                            {
                                return proxyEvent.Username == Username && machineEvent.ResourceURI != null &&
                                       machineEvent.ResourceURI.User == SIPEventDialogURI.User &&
                                       machineEvent.ResourceURI.Host == SIPEventDialogURI.Host;
                            }
                        }
                        else if ((machineEvent.MachineEventType ==
                                  SIPMonitorMachineEventTypesEnum.SIPRegistrarBindingRemoval ||
                                  machineEvent.MachineEventType ==
                                  SIPMonitorMachineEventTypesEnum.SIPRegistrarBindingUpdate) &&
                                 SIPEventPresenceURI != null)
                        {
                            ...
                            {
                                return proxyEvent.Username == Username && machineEvent.ResourceURI != null &&
                                       machineEvent.ResourceURI.User == SIPEventPresenceURI.User &&
                                       machineEvent.ResourceURI.Host == SIPEventPresenceURI.Host;
                            }
                        }
            ...
            else
            {
                ...
                string serverAddress = (consoleEvent.ServerEndPoint != null)
                    ? consoleEvent.ServerEndPoint.Address.ToString()
                    : null;
                string remoteIPAddress = (consoleEvent.RemoteEndPoint != null)
                    ? consoleEvent.RemoteEndPoint.Address.ToString()
                    : null;
                string dstIPAddress = (consoleEvent.DestinationEndPoint != null)
                    ? consoleEvent.DestinationEndPoint.Address.ToString()
                    : null;

                if (SIPRequestFilter != WILDCARD && consoleEvent.Message != null &&
                    consoleEvent.EventType == SIPMonitorEventTypesEnum.FullSIPTrace)
                {
                        ...
                        ShowServer(consoleEvent.ServerType))
                    {
                        ...
                        else if (SIPRequestFilter == SIPREQUEST_NOTIFY_VALUE)
                        {
                            ...
                            if (Regex.Match(consoleEvent.Message, "(NOTIFY|SUBSCRIBE) +?sips?:",
                                    RegexOptions.IgnoreCase).Success ||
		...
		public class ProxyMonitorFilterUnitTest
		{
            ...
            public void RequestRejectionUnitTest()
            {
                ...
                SIPMonitorEvent monitorEvent =
 new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.AppServer, SIPMonitorEventTypesEnum.FullSIPTrace, registerRequest, "test");
 ...
 new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.AppServer, SIPMonitorEventTypesEnum.FullSIPTrace, registerRequest, "test");
            ...
            public void ShowIPAddressUnitTest()
            {
                ...
                SIPMonitorEvent monitorEvent =
 new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.AppServer, SIPMonitorEventTypesEnum.FullSIPTrace, "blah blah", String.Empty, null, SIPEndPoint.ParseSIPEndPoint("10.0.0.1"));
                bool showEventResult = filter.ShowSIPMonitorEvent(monitorEvent);
            ...
            public void ShowInternalIPAddressUnitTest()
            {
                ...
                SIPMonitorEvent monitorEvent =
 new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.AppServer, SIPMonitorEventTypesEnum.FullSIPTrace, "blah blah", String.Empty, null, SIPEndPoint.ParseSIPEndPoint("127.0.0.1"));
                bool showEventResult = filter.ShowSIPMonitorEvent(monitorEvent);
            ...
            public void BlockIPAddressUnitTest()
            {
                ...
                SIPMonitorEvent monitorEvent =
 new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.AppServer, SIPMonitorEventTypesEnum.FullSIPTrace, "blah blah", String.Empty, SIPEndPoint.ParseSIPEndPoint("127.0.0.2"), null);
                bool showEventResult = filter.ShowSIPMonitorEvent(monitorEvent);
            ...
            public void FullTraceSIPSwitchUnitTest()
            {
                ...
                SIPMonitorEvent monitorEvent =
 new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.AppServer, SIPMonitorEventTypesEnum.FullSIPTrace, inviteRequest, null);
                bool showEventResult = filter.ShowSIPMonitorEvent(monitorEvent);
