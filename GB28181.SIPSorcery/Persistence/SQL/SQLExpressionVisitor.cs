        ...
        protected override Expression VisitUnary(UnaryExpression u)
        {
            switch (u.NodeType)
            {
                case ExpressionType.Not:
                    ...
                    break;
                default:
                    throw new NotSupportedException(string.Format("The unary operator '{0}' is not supported by SQL.",
                        u.NodeType));
            }
        ...
        protected override Expression VisitBinary(BinaryExpression b)
        {
            ...
            switch (b.NodeType)
            {
                ...
                case ExpressionType.GreaterThanOrEqual:
                    ...
                    break;
                default:
                    throw new NotSupportedException(string.Format("The binary operator '{0}' is not supported by SQL.",
                        b.NodeType));
            }
                        ...
                        case TypeCode.Object:
                            ...
                            else
                            {
                                throw new NotSupportedException(
                                    string.Format("The constant for '{0}' is not supported by SQL.", c.Value));
                            }
