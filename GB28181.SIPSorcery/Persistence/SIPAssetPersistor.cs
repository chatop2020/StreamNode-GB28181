...
namespace GB28181.Persistence
{
    ...
    public class SIPAssetPersistor<T>
    {
       // protected static ILog logger = AppState.logger;
        ...
        protected DbParameter GetParameter(DbProviderFactory dbProviderFactory, MetaDataMember member,
            object parameterValue, string parameterName)
        {
        ...
        protected void Increment(Guid id, string propertyName)
        {
            try
            {
                ...
                string commandText = "update " + m_objectMapper.TableName + " set " + propertyName + " = " +
                                     propertyName + " + 1 where id = '" + id + "'";
