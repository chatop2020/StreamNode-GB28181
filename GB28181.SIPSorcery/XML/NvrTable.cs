...
namespace GB28181.Sys.XML
{
    ...
    public class NvrTable : XmlHelper<NvrTable>, IDisposable
    {
        ...
        {
            get { return streamselect; }
            set { streamselect = value; }
        }
        ...
        public class ChannelItem
        {
            ...
            [XmlAttribute()] public int Cache { get; set; }
            ...
            [XmlAttribute()] public int Status { get; set; }
            [XmlAttribute()] public int RecordStatus { get; set; }
            [XmlAttribute()] public string AudioFomate { get; set; }
            [XmlAttribute()] public string VideoFomate { get; set; }
            [XmlAttribute()] public int RealStreamType { get; set; }
            [XmlAttribute()] public double Longitude { get; set; }
            [XmlAttribute()] public double Latitude { get; set; }

            [XmlAttribute()] public string Adddress { get; set; }
            [XmlAttribute()] public int IsPTZ { get; set; }
            [XmlAttribute()] public string EndTime { get; set; }
            [XmlAttribute()] public string Manufacturer { get; set; }
            [XmlAttribute()] public string Model { get; set; }
            [XmlAttribute()] public string Owner { get; set; }
            [XmlAttribute()] public string CivilCode { get; set; }
            [XmlAttribute()] public string Block { get; set; }

            [XmlAttribute()] public int Parental { get; set; }
            [XmlAttribute()] public int AccessType { get; set; } // 0 GB国标、1 其他类型
            [XmlAttribute()] public string ParentID { get; set; }
            [XmlAttribute()] public int SafetyWay { get; set; }
            [XmlAttribute()] public int RegisterWay { get; set; }
            [XmlAttribute()] public string CertNum { get; set; }
            [XmlAttribute()] public int Certifiable { get; set; }
            [XmlAttribute()] public int ErrCode { get; set; }

            [XmlAttribute()] public int Secrecy { get; set; }
            ...
            [XmlAttribute()] public int PTZType { get; set; }
            [XmlAttribute()] public int PositionType { get; set; }
            [XmlAttribute()] public int RoomType { get; set; }
            [XmlAttribute()] public int UserType { get; set; }
            [XmlAttribute()] public int SupplyLightType { get; set; }
            [XmlAttribute()] public int DirectionType { get; set; }
            [XmlAttribute()] public string Resolution { get; set; }
            [XmlAttribute()] public string BusinessGroupID { get; set; }
            [XmlAttribute()] public string DownloadSpeed { get; set; }
            [XmlAttribute()] public int SVCSpaceSupportMode { get; set; }
            [XmlAttribute()] public DateTime CreateTime { get; set; }
            [XmlAttribute()] public DateTime UpdateTime { get; set; }
            [XmlAttribute()] public int SVCTimeSupportMode { get; set; }

            [XmlAttribute()] public string SubordinatePlatform { get; set; } //所属上级/平台

            [XmlAttribute()] public string ExAttribute { get; set; } //自定义属性
    ...
    public enum DvsType
    {
        [Description("大华")] Dahua = 1,
        [Description("汉邦")] HB = 3,
        [Description("黄河")] HH = 5,
        [Description("海康")] Hik = 0,
        [Description("巨峰")] JF = 4,
        [Description("波粒")] WAPA = 6,
        [Description("科达")] KeDa = 7,
        [Description("朗驰")] Launet = 2,
        [Description("屏幕编码")] MirScreen = 8,
        [Description("Onvif")] Onvif = 9,
        [Description("RTSP")] RTSP = 10,
        [Description("RTP-MPEG-TS")] RTP = 11,
        [Description("GB28181")] GB28181 = 12,
        [Description("宇视")] UniView = 13,
        [Description("GB28059")] GB28059 = 14,
        [Description("GB28181Platform")] GB28181Platform = 15,
        [Description("RtmpPull")] RtmpPull = 16,
        [Description("RtmpPush")] RtmpPush = 17,
        [Description("天地伟业")] Tiandy = 18,
    }
    ...
    public class EnumContext
    {
        ...
        {
            get { return this._enumItem; }
            set { this._enumItem = value; }
        }
    }
}