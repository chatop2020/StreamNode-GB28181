            ...
            try
            {
                if (sdpDescription != null && sdpDescription.Trim().Length > 0)
                {
                    ...
                    foreach (string sdpLine in sdpLines)
                    {
                        ...
                        else if (sdpLine.Trim().StartsWith("c="))
                        {
                            if (activeAnnouncement != null)
                                activeAnnouncement.Connection =
                                    SDPConnectionInformation.ParseConnectionInformation(sdpLine);
                            else
                        ...
                        {
                            Match mediaMatch = Regex.Match(sdpLine.Substring(2).Trim(),
                        ...
                        else if (sdpLine.Trim().StartsWith(SDPMediaAnnouncement.MEDIA_FORMAT_ATTRIBUE_PREFIX))
                        {
                            if (activeAnnouncement != null)
                            {
                                Match formatAttributeMatch = Regex.Match(sdpLine.Trim(),
                        ...
                        else if (sdpLine.Trim()
                            .StartsWith(SDPMediaAnnouncement.MEDIA_FORMAT_PARAMETERS_ATTRIBUE_PREFIX))
                        {
                            if (activeAnnouncement != null)
                            {
                                Match formatAttributeMatch = Regex.Match(sdpLine.Trim(),
