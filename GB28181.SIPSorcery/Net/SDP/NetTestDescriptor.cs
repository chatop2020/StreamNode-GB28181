    ...
    public class NetTestDescriptor
    {
        public const int
            MAXIMUM_PAYLOAD_SIZE =
                1460; // Ethernet MTU = 1500. (12B RTP header, 8B UDP Header, 20B IP Header, TOTAL = 40B).

        public const int
            MAXIMUM_RATEPER_CHANNEL =
                500000; // This is in bits. Needs to be less than 1460B * 8bits * 66.667 Packets/s, so 500Kbps is a nice number.
     ...
     //   protected static ILog logger = AppState.logger;
        ...
        public int
            FrameSize = 20; // In milliseconds, determines how often packets are transmitted, e.g. framezie=20ms results in 50 packets per second.
