...
namespace GB28181.Net
{
    ...
    public class RTPSink
    {
        ...
        public const int
            RTP_BASEFRAME_SIZE =
                15; // This should only be set in increments of 15ms because the timing resolution of Windows/.Net revolves around this figure. This means

        // that even if it is set at 10, 20 or 40 it will ultimately end up being more like 15, 30 or 60.
        public const int
            RTP_DEFAULTPACKET_SIZE =
                160; // Corresponds to the default payload size for a 20ms g711 packet. Not a good idea to go 
        ...
        private ArrayList
            m_rtpChannels =
                new ArrayList(); // Use SetRTPChannels to adjust. List of the current RTPHeader's representing an 
        ...
        public int
            RTPMaxStayAlive =
                0; // If > 0 this specifies the maximum number of seconds the RTP stream will send for, after that time it will self destruct.

        private int
            m_channels =
                1; // This is a feature that will burst each RTP packet m_channels times, it's a way of duplicating simultaneous calls.
        ...
        public uint
            LastReceivedReportNumber = 0; // The report number of the last RTCP report received from the remote end.
        ...
        public RTPSink(IPAddress localAddress, ArrayList inUsePorts)
        {
            ...
            Logger.Logger.Info("RTPSink established on " + m_localEndPoint.Address.ToString() + ":" +
