...
namespace GB28181.Net
{
    public class RTSPClient
    {
        ...
        private const int
            RTP_TIMEOUT_SECONDS =
                15; // If no RTP packets are received during this interval then assume the connection has failed.
     ...
     //   private static ILog logger = AssemblyStreamState.logger;
        ...
        public void Play()
        {
            ...
            {
                throw new ApplicationException(
                    "Zero bytes were read from the RTSP client socket in response to a PLAY request.");
            }
        }
