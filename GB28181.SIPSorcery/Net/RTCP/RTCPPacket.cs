...
namespace GB28181.Net
{
    public class RTCPPacket
    {
        ...
        public RTCPPacket(uint senderSyncSource, ulong ntpTimestamp, uint rtpTimestamp, uint senderPacketCount,
        ...
        public byte[] GetBytes()
        {
            ...
            if (BitConverter.IsLittleEndian)
            {
                ...
                Buffer.BlockCopy(BitConverter.GetBytes(NetConvert.DoReverseEndian(SenderPacketCount)), 0, payload, 16,
                    4);
                Buffer.BlockCopy(BitConverter.GetBytes(NetConvert.DoReverseEndian(SenderOctetCount)), 0, payload, 20,
                    4);
            }
            else
            {
