...
namespace GB28181.Servers.SIPMonitor
{
    ...
    public class SIPMonitorCore : ISIPMonitorCore
    {
        ...
        private ConcurrentDictionary<string, SIPRequest> _syncRequestContext =
            new ConcurrentDictionary<string, SIPRequest>();

        public ConcurrentDictionary<string, SIPRequest> SyncRequestContext => _syncRequestContext;

        private ConcurrentQueue<Tuple<SIPRequest, SIPResponse>> _syncResponseContext =
            new ConcurrentQueue<Tuple<SIPRequest, SIPResponse>>();
        ...
        /// <param name="rtpServerIp"></param>
        /// <param name="rtpServerPort"></param>
        /// <param name="needResult"></param>
        /// <returns></returns>
        public int RealVideoReq(uint streamid, out string callid, string rtpServerIp, ushort rtpServerPort,
        ...
        public int RealVideoReq(uint streamid, out string callid, out string serverip, out int serverport,
            bool needResult = true)
        {
            ...
            sipRequest.Header.Subject = SetSubject();
            sipRequest.Header.ContentType = SIPHeader.ContentTypes.Application_SDP;
            sipRequest.Body = SetMediaReq(_sipAccount.MediaIP.ToString(), _mediaPort, streamid.ToString());
            serverip = _sipAccount.MediaIP.ToString();
            serverport = _mediaPort[0];
            _sipMsgCoreService.SendReliableRequest(RemoteEndPoint, sipRequest);
            _reqSession = sipRequest;
            if (needResult)
            {
        ...
        public int RealVideoReq(int[] mediaPort, string receiveIP, bool needResult = false)
        {
            ...
            sipRequest.Header.ContentType = SIPHeader.ContentTypes.Application_SDP;
            ulong streamName =
                CRC32Cls.GetCRC32(callId + RemoteEndPoint.Address.ToString() + RemoteEndPoint.Port.ToString());
            sipRequest.Body = SetMediaReq(receiveIP, mediaPort, streamName.ToString());
            _sipMsgCoreService.SendReliableRequest(RemoteEndPoint, sipRequest);
            _reqSession = sipRequest;
            if (needResult)
            {
        ...
        /// 结束实时视频请求
        /// </summary>
        public void ByeVideoReq(out string _callid, bool needResult = false)
        {
            if (_reqSession == null)
            {
                _callid = "";
            ...
            _callid = _reqSession.Header.CallId;
            Stop();
            if (needResult)
            {
        ...
        public void ByeVideoReq(string sessionid)
        {
            try
            {
                ...
                SIPToHeader to = reqSession.Header.To;
                to.ToTag = _toTag;
                SIPRequest byeReq = _sipTransport.GetRequest(SIPMethodsEnum.BYE, remoteUri);
        ...
        /// <returns></returns>
        private string SetMediaReq(string rtpServerIp, ushort rtpServerPort, string streamName, bool tcp = false)
        {
            var sdpConn = new SDPConnectionInformation(rtpServerIp);
        ...
        /// <returns></returns>
        private string SetMediaReq(string receiveIp, int[] mediaPort, string streamName)
        {
        ...
        {
            return DeviceId + ":" + 0 + "," + _sipMsgCoreService.LocalSIPId + ":" +
                   new Random().Next(100, ushort.MaxValue);
        }
        ...
        public int BackVideoReq(ulong beginTime, ulong endTime, int[] mediaPort, string receiveIP,
            bool needResult = false)
        {
            //_mediaPort = _sipMsgCoreService.SetMediaPort();
        ...
        public int VideoDownloadReq(DateTime beginTime, DateTime endTime, int[] mediaPort, string receiveIP,
            bool needResult = false)
        {
            //_mediaPort = _sipMsgCoreService.SetMediaPort();
        ...
        /// </summary>
        /// <returns></returns>
        public void BackVideoStopPlayingControlReq(bool needResult = false)
        {
            if (_reqSession == null)
            {
                return;
        ...
        /// <returns></returns>
        public bool BackVideoPlaySpeedControlReq(string range, bool needResult = false)
        {
            _mediaPort = _sipMsgCoreService.SetMediaPort();
            ...
            if (needResult)
            {
                _syncRequestContext.TryAdd(callId, realReq);
            }
        ...
        public bool BackVideoPlaySpeedControlReq(string sessionid, float scale, bool needResult = false)
        {
            try
            {
                //_mediaPort = _sipMsgCoreService.SetMediaPort();
        ...
        /// <returns></returns>
        private SIPRequest BackVideoPlaySpeedControlReq(string localIp, int[] mediaPort, string scale, string fromTag,
        ...
        private SIPRequest BackVideoPlaySpeedControlReq(string sessionid, float scale, string fromTag, int cSeq,
            string callId)
        {
        ...
        /// 恢复录像播放
        /// </summary>
        public void BackVideoContinuePlayingControlReq(bool needResult = false)
        {
            if (_mediaPort == null)
            {
                _mediaPort = _sipMsgCoreService.SetMediaPort();
        ...
        public bool BackVideoContinuePlayingControlReq(string sessionid, bool needResult = false)
        {
            try
            {
                //if (_mediaPort == null)
        ...
        /// <param name="callId">呼叫编号</param>
        /// <returns></returns>
        public SIPRequest BackVideoContinuePlayingControlReq(string localIp, int[] mediaPort, string fromTag, int cSeq,
            string callId)
        {
            SIPURI remoteUri = new SIPURI(DeviceId, RemoteEndPoint.ToHost(), "");
            SIPURI localUri = new SIPURI(_sipMsgCoreService.LocalSIPId, _sipMsgCoreService.LocalEP.ToHost(), "");
        ...
        /// 暂停录像播放
        /// </summary>
        public void BackVideoPauseControlReq(bool needResult = false)
        {
            if (_mediaPort == null)
            {
                _mediaPort = _sipMsgCoreService.SetMediaPort();
        ...
        public bool BackVideoPauseControlReq(string sessionid, bool needResult = false)
        {
            try
            {
                //if (_mediaPort == null)
                ...
                if (needResult)
                {
                    _syncRequestContext.TryAdd(_reqSession.Header.CallId, realReq);
                }
        ...
        /// <param name="callId">呼叫编号</param>
        /// <returns></returns>
        public SIPRequest BackVideoPauseControlReq(string localIp, int[] mediaPort, string fromTag, int cSeq,
            string callId)
        {
            SIPURI remoteUri = new SIPURI(DeviceId, RemoteEndPoint.ToHost(), "");
            SIPURI localUri = new SIPURI(_sipMsgCoreService.LocalSIPId, _sipMsgCoreService.LocalEP.ToHost(), "");
        ...
        public bool BackVideoPlayPositionControlReq(int range, bool needResult = false)
        {
            _mediaPort = _sipMsgCoreService.SetMediaPort();
            //uint time = TimeConvert.DateToTimeStamp(range);
            string localIp = _sipMsgCoreService.LocalEP.Address.ToString();
        ...
        public bool BackVideoPlayPositionControlReq(string sessionid, long time, bool needResult = false)
        {
            try
            {
                //_mediaPort = _sipMsgCoreService.SetMediaPort();
        ...
        /// <param name="callId">呼叫编号</param>
        /// <returns></returns>
        private SIPRequest BackVideoPlayPositionControlReq(string localIp, int[] mediaPort, int Time, string fromTag,
            int cSeq, string callId)
        {
            SIPURI remoteUri = new SIPURI(DeviceId, RemoteEndPoint.ToHost(), "");
            SIPURI localUri = new SIPURI(_sipMsgCoreService.LocalSIPId, _sipMsgCoreService.LocalEP.ToHost(), "");
        ...
        private SIPRequest BackVideoPlayPositionControlReq(string sessionid, long time, string fromTag, int cSeq,
            string callId)
        {
            if (!_syncRequestContext.Keys.Contains(sessionid)) return null;
            SIPRequest reqSession = _syncRequestContext[sessionid];
        ...
        /// </summary>
        public void HomePositionControl(bool isEnabled, bool needResult = false)
        {
            string fromTag = CallProperties.CreateNewTag();
            int cSeq = CallHelpers.CreateNewCSeq();
            string callId = CallProperties.CreateNewCallId();
            ...
            if (needResult)
            {
                _syncRequestContext.TryAdd(callId, presetReq);
            }
        ...
        public void MakeKeyFrameRequest(bool needResult = false)
        {
            string fromTag = CallProperties.CreateNewTag();
            int cSeq = CallHelpers.CreateNewCSeq();
            string callId = CallProperties.CreateNewCallId();
