...
namespace GB28181.Servers
{
    public class SIPServiceDirector : ISIPServiceDirector
    {
        ...
        /// <param name="deviceid"></param>
        public void PtzControl(PTZCommand ptzCommand, int dwStop, int speed, string deviceid, string channelId = "")
        {
            _sipCoreMessageService.PtzControl(ptzCommand, dwStop, speed, deviceid, channelId);
        }
