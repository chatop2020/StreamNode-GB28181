...
namespace GB28181.Servers
{
    ...
    public interface ISIPMonitorCore : IMediaAction
    {
        ...
        void PtzContrl(out string _callid, PTZCommand ucommand, int dwStop, int dwSpeed, bool needResult = false,
            string channelId = "");
        ...
        /// </summary>
        void HomePositionControl(bool isEnabled, bool needResult = false);
        ...
        //强制关键帧命令请求
        void MakeKeyFrameRequest(bool needResult = false);
    }
