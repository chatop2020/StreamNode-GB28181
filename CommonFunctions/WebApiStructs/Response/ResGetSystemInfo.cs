        ...
        public OStype? OStype
        {
            get
            {
                ...
                if (islinux)
                {
                    ...
                    {
                        return Response.OStype.LinuxX32;
                    }
                    else
                    {
                        return Response.OStype.LinuxX64;
                    }
                }
                ...
                if (iswin)
                {
                    ...
                    {
                        return Response.OStype.WindowsX32;
                    }
                    else
                    {
                        return Response.OStype.WindowsX64;
                    }
                }
                ...
                if (ismac)
                {
                    ...
                    {
                        return Response.OStype.MacOSX32;
                    }
                    else
                    {
                        return Response.OStype.MacOSX64;
                    }
                }
                ...
                var isunix = SystemHelper.IsUnix();
                {
                    ...
                    {
                        return Response.OStype.UnixX32;
                    }
                    else
                    {
                        return Response.OStype.UnixX64;
                    }
                }
                return Response.OStype.Unknow;
            }
        }
