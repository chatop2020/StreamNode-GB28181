...
namespace SIPSorcery.SIP
{
    ...
    public class SIPResponse : SIPMessageBase
    {
        ...
        [Obsolete(
            "The local and remote SIP end points are now only for recording receiving sockets. Use the new send from hint proprties.",
            true)]
        public SIPResponse(
            SIPResponseStatusCodesEnum responseStatus,
            string reasonPhrase,
        ...
        public static SIPResponse ParseSIPResponse(SIPMessageBuffer sipMessageBuffer)
        {
            ...
            {
                Logger.Logger.Error(
                    "Exception ParseSIPResponse. ->" + sipMessageBuffer.RawMessage + "->" + excp.Message);
            ...
            string reasonPhrase)
        {
            ...
            {
                Logger.Logger.Error("Exception SIPResponse.GetResponse. ->" + excp.Message);
                throw excp;
            }
        }
