...
namespace SIPSorcery.SIP.App
{
    ...
    public class SIPMonitorClientTypes
    {
        ...
        {
            return (SIPMonitorClientTypesEnum) Enum.Parse(typeof(SIPMonitorClientTypesEnum), eventTypeId.ToString(),
                true);
        }
    }
    ...
    public class SIPMonitorEventTypes
    {
        ...
        {
            return (SIPMonitorEventTypesEnum) Enum.Parse(typeof(SIPMonitorEventTypesEnum), eventTypeId.ToString(),
                true);
        }
    }
    ...
    public class SIPMonitorServerTypes
    {
        ...
        {
            return (SIPMonitorServerTypesEnum) Enum.Parse(typeof(SIPMonitorServerTypesEnum), serverTypeId.ToString(),
                true);
        }
    }
    ...
    public class SIPMonitorMachineEventTypes
    {
        ...
        {
            return (SIPMonitorMachineEventTypesEnum) Enum.Parse(typeof(SIPMonitorMachineEventTypesEnum), eventTypeName,
                true);
        }

        public static SIPMonitorMachineEventTypesEnum GetMonitorMachineTypeForId(int eventTypeId)
        {
            return (SIPMonitorMachineEventTypesEnum) Enum.Parse(typeof(SIPMonitorMachineEventTypesEnum),
                eventTypeId.ToString(), true);
        }
    }
    ...
    public class SIPMonitorEvent
    {
        ...
        public string
            MonitorServerID; // The ID of the monitoring server that received this event. Useful when there are multiple monitoring servers.
        ...
        public virtual string ToCSV()
        {
            throw new NotImplementedException(
                "SIPMonitorEvent ToCSV (this is a virtual method only, you should be using a sub-class).");
        }
    }
}
