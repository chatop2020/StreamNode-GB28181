...
namespace SIPSorcery.SIP.App
{
    public class SIPRequestAuthenticator
    {
        ...
        public static SIPRequestAuthenticationResult AuthenticateSIPRequest(SIPEndPoint localSIPEndPoint,
            ...
            SIPMonitorLogDelegate logSIPMonitorEvent)
        {
            try
            {
                if (sipAccount == null)
                ...
                else if (sipAccount.IsDisabled)
                {
                    ...
                    {
                        logSIPMonitorEvent(new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.Authoriser,
                            SIPMonitorEventTypesEnum.DialPlan,
                            "SIP account " + sipAccount.SIPUsername + "@" + sipAccount.SIPDomain + " is disabled for " +
                            sipRequest.Method + ".", sipAccount.Owner));
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (IsNonceStale(requestNonce))
                        {
                            ...
                            {
                                logSIPMonitorEvent(new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.Authoriser,
                                    SIPMonitorEventTypesEnum.Warn,
                                    "Authentication failed stale nonce for realm=" + sipAccount.SIPDomain +
                                    ", username=" + sipAccount.SIPUsername + ", uri=" + uri + ", nonce=" +
                                    requestNonce + ", method=" + sipRequest.Method + ".", null));
                            }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (logSIPMonitorEvent != null)
                                {
                                    logSIPMonitorEvent(new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.Authoriser,
                                        SIPMonitorEventTypesEnum.Warn,
                                        "Authentication token check failed for realm=" + sipAccount.SIPDomain +
                                        ", username=" + sipAccount.SIPUsername + ", uri=" + uri + ", nonce=" +
                                        requestNonce + ", method=" + sipRequest.Method + ".", sipAccount.Owner));
                                }
            ...
            catch (Exception excp)
            {
                ...
                {
                    logSIPMonitorEvent(new SIPMonitorConsoleEvent(SIPMonitorServerTypesEnum.Authoriser,
                        SIPMonitorEventTypesEnum.Error, "Exception AuthoriseSIPRequest. " + excp.Message, null));
                }
