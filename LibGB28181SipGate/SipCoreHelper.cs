    ...
    public class SipCoreHelper
    {
        ...
        public bool ReqLiveForCreateRptPort(string devId, string rptServerIp, ushort rptPort, bool tcp = false)
        {
            ...
            if (!string.IsNullOrEmpty(pid))
            {
                ...
                if (ret)
                {
                    ...
                    Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + " 请求实时视频成功");
                }
                else
                {
                    var obj = _sipDeviceList.FindLast(x => x.DeviceId.Equals(pid));
                    ...
                    Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + "  请求实时视频失败");
                }
        ...
        public bool ReqStopLive(string devId)
        {
            ...
            if (!string.IsNullOrEmpty(pid))
            {
                ...
                if (ret)
                {
                    ...
                    Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + " 请求终止实时视频成功");
                }
                else
                {
                    Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + "  请求终止实时视频失败");
                }
        ...
        public bool ReqPtzControl(string devId, string dir, int speed)
        {
            ...
            if (dev != null)
            {
                ...
                if (ret)
                {
                    Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + " 请求PTZ控制成功");
                }
                else
                {
                    Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + "  请求PTZ控制失败");
                }
        ...
        public bool GetDeviceList(string devId)
        {
            ...
            if (ret)
            {
                Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + " 获取设备目录成功");
            }
            else
            {
                Console.WriteLine(gdlt.DeviceId + ":" + gdlt.CallId + " 获取设备目录失败");
            }
